        ...
        index_settings = {
            "settings": {
                ...
                "analysis": {
                    "filter": {"autocomplete_filter": {"type": "edge_ngram", "min_gram": 1, "max_gram": 20},
                               "synonym_filter": {"type": "synonym", "synonymps_path": "analyzers/F39598502"}
                               },
                    "analyzer": {
                        "autocomplete": {
                            "type": "custom",
            ...
            "mapings": {
                "doc": {
                    "properties": {
                        "id": {"type": "text"},
                        "format": {"type": "text", "index": "not_analyzed"},
                        "name": {"type": "text", "index": "not_analyzed"},
                        "title": {"type": "text","index": "not_analyzed"},
                        "drug_name": {"type": "text", "index": "not_analyzed"},
                        "active_substance": {"type": "text", "index": "not_analyzed"},
                        "strength": {"type": "text", "index": "not_analyzed"},
                        "data_source": {"type": "text","index": "not_analyzed"},
                        "license_holder": {"type": "text","index": "not_analyzed"},
                        "year_of_authorization": {"type": "date"},
                        "route_of_administration": {"type": "text","index": "not_analyzed"},
                        "submission_date_for_initial_approval": {"type": "date"},
                        "approval_type":{"type":"text","index": "not_analyzed"},
                        "document_type": {"type": "text","index": "not_analyzed"},
                        "approval_status": {"type": "text", "index": "not_analyzed"},
                        "body_text": {"type": "text",
                                      "term_vector": "with_positions_offsets",
                                      "analyzer": ["synonym_analyzer", "autocomplete"]
                                      },
                        "body_nested": {"type": "nested"},
                        "meta_nested": {"type": "nested"},
                        "source_url": {"type": "text", "index":"not_analyzed"},
